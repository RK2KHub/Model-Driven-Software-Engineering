...
public class GeneralManagerTest {
	...
	@Test
	public void testViewActiveReservations () {
        ...
        customer.setEmail("ed7@mail.com");
        customer.setName("ed7");
        ...
        assertNotNull(customer.getReservation().getGeneralManager().getReservations());
	}
}
